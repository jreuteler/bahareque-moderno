# BaharequeModerno — Filosofia Progettuale
...
Pareti tradizionali giapponesi in terra costruite su un intreccio di bambù (*komai*). Strati multipli di intonaco di terra vengono applicati sul bambù intrecciato — intonaco di base grossolano, strato intermedio e strato di finitura fine. Lo stesso approccio stratificato (intreccio strutturale + rivestimento minerale + finitura in intonaco fine) utilizzato in questo sistema di pannelli.
...
- **Trasformare i problemi in soluzioni:** L'erba stella invasiva (*Cynodon nlemfuensis*), un comune infestante agricolo, viene essiccata, sminuzzata e utilizzata come fibra di rinforzo nell'intonaco di calce. Rimuovere la specie invasiva migliora il terreno; utilizzarla nella costruzione chiude il ciclo.
...
### Bahareque Ingegnerizzato — Sebastian Kaminski (Arup / INBAR)
...
- [Dezeen — Edilizia in bambù Blue Temple](https://www.dezeen.com/2025/12/30/blue-temple-housing-now-bamboo-housing-myanmar/)
...
- [Quincha Prefabbricata (ResearchGate)](https://www.researchgate.net/publication/270074951_Sistema_constructivo_Quincha_Prefabricada)
- [Manuale Quincha Migliorata (PREDES)](https://www.predes.org.pe/wp-content/uploads/2017/11/manual_quincha_mejorada.pdf)

### NSR-10 Colombiano — Standard Bahareque Encementado

Non un sistema ma il quadro normativo: il codice sismico colombiano NSR-10, Capitolo G-1 (precedentemente E-7), disciplina la costruzione in bahareque cementato. Qualsiasi edificio che utilizzi questo sistema di pannelli in Colombia farebbe riferimento a questo standard. Il codice riconosce il telaio in guadua + stuoia di bambù + rete metallica + malta cementizia come sistema murario conforme al codice.

- [Manuale Bahareque Encementado (PDF)](https://www.desenredando.org/public/libros/2001/csrvbe/guadua_lared.pdf)
...
Questo sistema è un'evoluzione, non un'invenzione da zero. Combina principi collaudati di bahareque, quincha, Fachwerk e costruzione pombalina con ingegneria moderna, scienza dei materiali e distribuzione open-source.
