# BaharequeModerno — Filosofia de Projeto
...
Paredes tradicionais japonesas de terra construídas sobre uma treliça de bambu (*komai*). Múltiplas camadas de reboco de terra são aplicadas sobre o bambu entrelaçado — camada base grosseira, camada intermediária e camada de acabamento fino. A mesma abordagem em camadas (treliça estrutural + envolvimento mineral + acabamento fino de reboco) usada neste sistema de painéis.
...
- **Transformar problemas em soluções:** A grama-estrela invasora (*Cynodon nlemfuensis*), uma praga agrícola comum, é seca, picada e usada como reforço de fibra no reboco de cal. Remover a espécie invasora melhora a terra; usá-la na construção fecha o ciclo.
...
Este projeto não existe no vácuo. Vários sistemas exploraram construção pré-fabricada ou engenheirada à base de bambu. Construímos sobre o trabalho deles e reconhecemos suas contribuições.
...
### Housing NOW / Blue Temple — Mianmar
...
- [Dezeen — Habitação de bambu Blue Temple](https://www.dezeen.com/2025/12/30/blue-temple-housing-now-bamboo-housing-myanmar/)
